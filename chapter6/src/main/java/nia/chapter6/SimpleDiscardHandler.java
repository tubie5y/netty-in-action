...
/**
 * Listing 6.2 Using SimpleChannelInboundHandler (使用SimpleChannelInboundHandler)
 *
...
public class SimpleDiscardHandler extends SimpleChannelInboundHandler<Object> { // 扩展了SimpleChannelInboundHandler
    /**
     * 消费入站消息的简单方式:
     *      由于消费入站数据是一项常规任务，所以Netty提供了一个特殊的被称为SimpleChannelInboundHandler的ChannelInboundHandler实现。这个实现会在消息被channelRead0()方法消费之后自动释放消息。
     */
    @Override
